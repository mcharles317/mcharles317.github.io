...
teamcluster_2021 <- teamcluster_2021 %>% mutate(wins.x = as.numeric(wins.x))
...
```{r}
ggplot() +
  geom_point(data=teamcluster_2021, aes(x=fg_3pt, y=three_point_attempts, size = wins.x, color=k6_2021.cluster)) +
geom_point(data=Bucks, aes(x=fg_3pt, y=three_point_attempts, size = wins.x), colour = 'red')
```
...
```{r}
ggplot() +
  geom_point(data=teamcluster_2017, aes(x=fg_3pt, y=ThreePointAttempts, color=k6_2017$cluster, size=wins.x)) +
  geom_point(data=Warriors2017, aes(x=fg_3pt, y=ThreePointAttempts, size=wins.x), colour= "red")
```
...
```{r}
ggplot() +
  geom_point(data=teamcluster_2016, aes(x=fg_3pt, y=ThreePointAttempts, color=k6_2016$cluster, size=wins)) +
  geom_point(data=Cavs, aes(x=fg_3pt, y=ThreePointAttempts, size=wins.x), colour= "red")
```

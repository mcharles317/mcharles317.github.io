...
nba_team_box_better <- nba_team_box_better %>% 
  filter(team_name!= "All-Stars", team_name!= "Team LeBron", team_name!= "World", team_name!= "USA", team_name!= "Team Stephen", team_name!= "Team Giannis", team_name!= "Team Durant")
```
...
```{r}
ggplot() +
  geom_point(data=teamcluster_2021, aes(x=ThreePointMakes, y=Assists, color=k6_2021.cluster))
geom_point(data=Bucks, aes(x=ThreePointMakes, y=Assists, color= red))
```
#2020 Season below
```{r}
...
cluster7_2020<- teamcluster_2020 %>% filter(k6_2020.cluster == 7)
```

```{r}
ggplot() +
  geom_point(data=teamcluster_2020, aes(x=ThreePointMakes, y=Assists, color=k6_2020.cluster)) +
  geom_point(data=Lakers, aes(x=ThreePointMakes, y=Assists), color="red")
```
...
```{r}
ggplot() +
  geom_point(data=teamcluster_2019, aes(x=ThreePointMakes, y=Assists, color=k6_2019.cluster)) +
  geom_point(data=Raptors, aes(x=ThreePointMakes, y=Assists), color="red")
```
...
cluster6_2018 <- teamcluster_2018 %>% filter(k6_2018.cluster == 6)
```

```{r}
ggplot() +
  geom_point(data=teamcluster_2018, aes(x=ThreePointMakes, y=Assists, color=k6_2018.cluster)) +
  geom_point(data=Warriors, aes(x=ThreePointMakes, y=Assists), color="red")
```
...
cluster7_2017<- teamcluster_2017 %>% filter(k6_2017.cluster == 7)
```

```{r}
ggplot() +
  geom_point(data=teamcluster_2017, aes(x=ThreePointMakes, y=Assists, color=k6_2017.cluster)) +
  geom_point(data=Warriors2017, aes(x=ThreePointMakes, y=Assists), color="red")
```
...
cluster6_2016<- teamcluster_2016 %>% filter(k6_2016.cluster == 6)
```
```{r}
ggplot() +
  geom_point(data=teamcluster_2016, aes(x=ThreePointMakes, y=Assists, color=k6_2016.cluster)) +
  geom_point(data=Cavs, aes(x=ThreePointMakes, y=Assists), color="red")
```

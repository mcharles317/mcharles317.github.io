...
nba_team_box_better <- nba_team_box %>%
  ...
  mutate(three_point_makes= as.numeric(three_point_makes), three_point_attempts= as.numeric(three_point_attempts ), total_rebounds= as.numeric(total_rebounds), total_turnovers =as.numeric(total_turnovers), points_in_paint= as.numeric(points_in_paint), assists= as.numeric(assists), game_date = as.numeric(game_date))
...
filter(between(game_date, as.Date(2020-12-20), as.Date(2021-05-19))) %>% 
  group_by (team_name) %>% 
...
cluster2<- teamcluster_2021 %>% filter(k6_2021.cluster == 2)

```

```{r}
ggplot() +
  geom_point(data=teamcluster_2021, aes(x=ThreePointMakes, y=TotalTurnovers, color=k6_2021.cluster))
...
cluster2_2020<- teamcluster_2020 %>% filter(k6_2020.cluster == 2)
```
...
cluster2_2019<- teamcluster_2019 %>% filter(k6_2019.cluster == 2)
```
...
cluster4_2018 <- teamcluster_2018 %>% filter(k6_2018.cluster == 4)
```
...
cluster2_2017<- teamcluster_2017 %>% filter(k6_2017.cluster == 2)
